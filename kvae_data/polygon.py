...
if __name__ == '__main__':
    ...
    cannon.run(delay=None, iterations=20, sequences=6000, radius=3 * scale, angle_limits=(0, 360), shape=2,
               velocity_limits=(10.0 * scale, 15.0 * scale), filepath=kvae_dir_data.joinpath('polygon.npz'), save='npz')
